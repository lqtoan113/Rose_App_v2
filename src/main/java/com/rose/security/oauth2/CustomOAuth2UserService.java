package com.rose.security.oauth2;

import com.rose.entities.Account;
import com.rose.entities.enums.EAuthProvider;
import com.rose.exceptions.OAuth2AuthenticationProcessingException;
import com.rose.security.UserPrincipal;
import com.rose.security.oauth2.user.OAuth2UserInfo;
import com.rose.security.oauth2.user.OAuth2UserInfoFactory;
import com.rose.services.impl.AccountServiceImpl;
import com.rose.services.impl.RoleServiceImpl;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        Optional<Account> userOptional = accountService.findByUsernameOrEmail(oAuth2UserInfo.getEmail());
        Account user;
        if(userOptional.isPresent()) {
            ...
            if(!user.getProvider().equals(EAuthProvider.valueOf(oAuth2UserRequest.getClientRegistration().getRegistrationId()))) {
                ...
                throw new OAuth2AuthenticationProcessingException("Your account has been banned!");
            }
    ...
    private Account updateExistingUser(Account existingUser, OAuth2UserInfo oAuth2UserInfo) {
        ...
        return accountService.updateAccount(existingUser);
    }
