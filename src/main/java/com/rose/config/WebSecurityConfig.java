...
import com.rose.security.RestAuthenticationEntryPoint;
import com.rose.security.TokenAuthenticationFilter;
import com.rose.security.oauth2.CustomOAuth2UserService;
import com.rose.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/v2/auth/**",
                        ...
                        "/v3/api-docs/**")
                .permitAll()
                .antMatchers("/api/v2/products/**",
                        "/api/v2/collections/**",
                        "api/v2/colors/**",
                        "api/v2/sizes/**",
                        "api/v2/products/**/comments/**",
